...
Texture::Texture(const std::string& path, int WrapMethod)
	...
	m_Width(0), m_Height(0), m_BPP(0)
{
	...
	GLCall(glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, WrapMethod));
	GLCall(glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, WrapMethod));
